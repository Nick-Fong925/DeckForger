...
DeckForge is a full-stack flashcard generation app (TypeScript + React + Express + Supabase + Firebase Auth + GCP). It is being built as a structured learning project. See the planning report for full architecture, phased implementation plan, and gotchas.
...
- Supabase with service role key on the server; ownership enforced in route handlers, not RLS
